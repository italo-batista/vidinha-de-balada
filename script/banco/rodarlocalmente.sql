...
load data local infile '/Users/michelly/Desktop/projetos/vidinha-de-balada/script/dados_gerados/tabela_selos_cota.csv' into table selosCota fields terminated by ','
  enclosed by '"'
  lines terminated by '\n'
    (id, idDeputado, ano, mes, selo);

load data local infile '/Users/michelly/Desktop/projetos/vidinha-de-balada/script/dados_gerados/tabela_selos_presencas.csv' into table selosPresenca fields terminated by ','
  enclosed by '"'
  lines terminated by '\n'
    (id, idDeputado, ano, mes, selo);
